...
| WorkloadAttestor | [windows](/doc/plugin_agent_workloadattestor_windows.md)                | A workload attestor which generates selectors based on systemd unit properties such as `Id` and `FragmentPath`                                  |
| WorkloadAttestor | [windows_service](/doc/plugin_agent_workloadattestor_windows_service.md)| A workload attestor which generates selectors based on systemd unit properties such as `Id` and `FragmentPath`                                  |
